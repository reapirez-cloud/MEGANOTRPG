...
test("Wizard reference exposes the rebuilt base class and translated subclasses", () => {
  ...
  assert.match(wizard, /wizardTashaReferenceSubclasses/)
  assert.match(wizard, /wizardSupplementReferenceSubclasses/)
})
