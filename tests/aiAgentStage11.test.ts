...
test("image profiles map semantic quality onto CheapVibeCode GPT Image 2.5 Sunburst", () => {
  ...
  assert.match(profiles, /model: "gpt-image-2\.5-sunburst"/)
  assert.doesNotMatch(profiles, /model: "gpt-image-2"/)
  assert.doesNotMatch(profiles, /quality: "medium"|quality: "xhigh"|quality: "max"/)
