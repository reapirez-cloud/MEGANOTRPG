...
- Reconciled the two already-red Stage 2 chat assertions with the current Stage 6 composer action launcher/ChatActionHost architecture; this is test maintenance only and does not restore the discarded old header quick-action UI.
