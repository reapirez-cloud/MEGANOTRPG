            ...
            <>
              ...
              {panel.content && (
                <section className="u1-ai-gm-card">
                  ...
                  <p>
                    Отдельно от режима мастера. Разрешает ИИ использовать взрослые
                    темы для совершеннолетних персонажей без автоматического
                    смягчения сцены. Это не меняет характер NPC, их согласие,
                    канон или механику.
                  </p>
                  <div className="u1-ai-gm-behaviors">
