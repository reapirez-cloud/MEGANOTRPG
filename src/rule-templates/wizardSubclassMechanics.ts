...
const illusionist: RuntimeSubclass = {
  ...
  levels: {
    ...
    6: [
      ...
      spell("illusionist-summon-beast-access", "wizard:illusionist:phantasmal-creatures", "summon-beast", "Призыв зверя", 2, "conjuration", "always_prepared", [slotMethod(2), { key: "phantom-free", kind: "spell", ability: "intelligence", saveDc: spellDc, requiresPrepared: false, resourceOptions: [{ key: "free", label: "Бесплатный призрачный призыв", costs: [{ key: "wizard_illusionist_free_summon_beast", amount: 1 }] }] }]),
      spell("illusionist-summon-fey-access", "wizard:illusionist:phantasmal-creatures", "summon-fey", "Призыв феи", 3, "conjuration", "always_prepared", [slotMethod(3), { key: "phantom-free", kind: "spell", ability: "intelligence", saveDc: spellDc, requiresPrepared: false, resourceOptions: [{ key: "free", label: "Бесплатный призрачный призыв", costs: [{ key: "wizard_illusionist_free_summon_fey", amount: 1 }] }] }]),
    ],
    10: [
