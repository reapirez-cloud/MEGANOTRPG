...
const subclasses: RuntimeSubclass[] = [
  ...
  },
  {
    ...
    levels: {
      3: mergeRow(draconicSpells[3], [feature("draconic-resilience", "sorcerer:draconic:resilience", "sorcerer_draconic_resilience", "Драконья стойкость", "При получении подкласса на 3 уровне максимум HP увеличивается на 3. Каждый следующий уровень чародея увеличивает максимум HP ещё на 1. Пока вы без доспеха, базовая КД равна 10 + модификатор Ловкости + модификатор Харизмы.", { kind: "draconic_resilience", initialHpIncrease: 3, hpPerFutureSorcererLevel: 1, armorClassFormula: "10+dex+cha", requiresUnarmored: true })]),
  ...
  },
  {
    ...
    summary: "Дикие всплески управляют случайными эффектами после заклинаний, а Приливы хаоса, Изгиб удачи и Укрощённый всплеск дают ограниченный контроль над вероятностью.",
    levels: {
      3: [feature("wild-surge", "sorcerer:wild:surge", "sorcerer_wild_magic_surge", "Дикий всплеск", "Один раз за ход сразу после сотворения заклинания чародея с расходом ячейки вы можете бросить d20. При результате 20 бросьте по таблице Дикой магии; если результат таблицы является заклинанием, к нему нельзя применить Метамагию.", { kind: "wild_magic_surge", triggerRoll: "1d20", triggerResult: 20, gmTableResolution: true }), feature("wild-tides", "sorcerer:wild:tides", "sorcerer_wild_tides_of_chaos", "Приливы хаоса", "Перед одним D20 Test вы можете дать себе преимущество. После применения способность недоступна, пока вы не сотворите заклинание чародея с расходом ячейки или не закончите долгий отдых. Если вы сотворяете такое заклинание до отдыха, сразу после него автоматически происходит Дикий всплеск и применение Приливов хаоса восстанавливается.", { kind: "tides_of_chaos", rechargeOnNextSorcererSlotSpell: true, automaticSurgeOnRecharge: true }), resource("wild-tides-use", "sorcerer:wild:tides", "sorcerer_wild_tides_of_chaos", "Приливы хаоса", 1, "long_rest"), semanticAction("wild-tides-action", "sorcerer:wild:tides", "sorcerer_wild_tides_of_chaos", "Приливы хаоса", "no_action", { gmD20Gate: true }, [{ key: "sorcerer_wild_tides_of_chaos", amount: 1 }]), action("wild-tides-surge-restore", "sorcerer:wild:tides", "sorcerer_wild_tides_of_chaos_restore_after_spell", "Дикий всплеск после Приливов хаоса", "no_action", { effects: [{ kind: "resource", key: "sorcerer_wild_tides_of_chaos", operation: "RESTORE", amount: 1 }, { kind: "semantic", key: "wild_magic_surge", payload: { automatic: true, trigger: "next_sorcerer_spell_with_slot", gmTableResolution: true } }], tags: ["sorcerer", "subclass", "wild-magic", "spell-trigger"] })],
  ...
  },
  {
    ...
    levels: {
      3: [feature("shadow-eyes", "sorcerer:shadow:eyes", "sorcerer_shadow_eyes_of_the_dark", "Глаза тьмы", "Вы получаете тёмное зрение 120 футов. С 3 уровня можете сотворить Тьму за 2 Очка чародейства и видеть сквозь созданную таким образом Тьму.", { kind: "eyes_of_the_dark", darkvisionFeet: 120, seeThroughOwnDarkness: true }), featureSpell("shadow-magic", "sorcerer:shadow:eyes", "eyes-of-the-dark", { slug: "darkness", name: "Тьма", level: 2, school: "Evocation" }, [{ key: "sorcery_points", amount: 2 }]), feature("shadow-grave", "sorcerer:shadow:grave", "sorcerer_shadow_strength_of_grave", "Сила могилы", "Когда урон снижает вас до 0 HP и не убивает мгновенно, совершите спасбросок Харизмы Сл 5 + полученный урон; при успехе остаётесь на 1 HP. Не работает против критического или сияющего урона. Одно применение восстанавливается после долгого отдыха.", { kind: "strength_of_the_grave", save: "charisma", dc: "5+damage", exclusions: ["critical","radiant"] }), resource("shadow-grave-use", "sorcerer:shadow:grave", "sorcerer_shadow_strength_of_grave", "Сила могилы", 1, "long_rest"), semanticAction("shadow-grave-action", "sorcerer:shadow:grave", "sorcerer_shadow_strength_of_grave", "Сила могилы", "reaction", { gmZeroHpGate: true, save: "charisma", dc: "5+damage" }, [{ key: "sorcerer_shadow_strength_of_grave", amount: 1 }])],
