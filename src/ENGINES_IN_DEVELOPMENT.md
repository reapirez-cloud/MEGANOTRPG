...
> Read `../docs/ENGINE_ROADMAP.md` before refactoring gameplay state, classes, rolls, inventory, character/NPC persistence, world locations, maps, time or quest-journal behavior.
