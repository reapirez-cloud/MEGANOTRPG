...
export const classReference: ClassReferenceEntry[] = [
  ...
  },
  {
    ...
    name: "Монах",
    nameEn: "Monk",
    tagline: "Безоружный боец, превращающий дисциплину, скорость и фокус в оружие.",
    description: "Монах сражается без доспехов и почти без снаряжения: использует Ловкость и Мудрость для защиты, наращивает урон безоружных ударов, быстрее перемещается и расходует Очки фокуса на серии атак, оборону и рывки. Чем выше уровень, тем меньше обычные ограничения тела — падения, яд, страх, взрывы и даже часть энергетических атак — способны остановить его. Подклассы будут подключены отдельным пакетом после базового класса.",
    subclasses: [],
  },
  {
    id: "wizard",
