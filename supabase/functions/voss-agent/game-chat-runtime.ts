...
const STAGE12_GAME_MASTER_SYSTEM = [
  ...
  "Перед тобой cooperative runtime Stage 12: один игровой чат персонажа сохраняется при перемещениях. Сервер сериализует GM-turn по persistent room; location_id — текущее физическое состояние, а не граница истории чата.",
