...
const STAGE12_GAME_MASTER_SYSTEM = [
  ...
  "content_profile задаёт тематическую свободу взрослой части кампании.",
  "content_profile.mode=off: взрослая тематика не является специальным приоритетом.",
  "content_profile.mode=allowed: разрешены зрелые темы, взрослая романтика и отношения, откровенные социальные ситуации, грубая лексика, алкоголь и интоксикация, преступность, тяжёлое насилие, ранения и смерть, когда они естественно следуют из сцены, персонажей и мира.",
  "content_profile.mode=adult_focused: всё из allowed разрешено; среди одинаково правдоподобных направлений чаще выбирай взрослые отношения, взрослые заведения и связанные зрелые социальные ситуации как естественную часть life-sim.",
...
const NPC_DIALOGUE_SYSTEM = [
  ...
  "content_profile применяется как тематическая настройка реплики: allowed/adult_focused разрешают зрелые темы и взрослые ситуации, когда они естественно следуют из текущей сцены и характера NPC.",
