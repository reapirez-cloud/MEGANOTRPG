...
const CREATE_IMAGE_COMMAND =
  /(?:^|[.!?]\s*|,\s*|(?:теперь|тогда|давай|ладно|окей|ок|всё|все|можешь|прошу)\s+)(?:создай|create|generate|draw)\s+(?:(?:a|an|the)\s+)?(?:мне\s+)?(?:арт|изображение|картинку|рисунок|иконку|аватар|портрет|панораму|рендер|image|picture|icon|avatar|portrait|render)(?![\p{L}\p{N}_])/u
