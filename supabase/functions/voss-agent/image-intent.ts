const DRAW_COMMAND =
  /(?:^|[.!?]\s*|,\s*|\b(?:теперь|тогда|давай|ладно|окей|ок|всё|все|можешь|прошу)\s+)(?:рисуй|нарисуй|отрисуй|перерисуй|дорисуй|сгенерируй|генерируй)\b/u

const CREATE_IMAGE_COMMAND =
  /(?:^|[.!?]\s*|,\s*|\b(?:теперь|тогда|давай|ладно|окей|ок|всё|все|можешь|прошу)\s+)(?:создай|create|generate|draw)\s+(?:мне\s+)?(?:арт|изображение|картинку|рисунок|иконку|аватар|портрет|панораму|рендер|image|picture|icon|avatar|portrait|render)\b/u

const NEGATED_DRAW_COMMAND =
  /(?:^|[.!?]\s*|,\s*|\b)(?:не|пока\s+не|ещ[её]\s+не|не\s+надо|не\s+нужно|не\s+стоит)\s+(?:мне\s+)?(?:рисуй|нарисуй|отрисуй|перерисуй|дорисуй|сгенерируй|генерируй|создай|generate|draw|create)\b/gu
