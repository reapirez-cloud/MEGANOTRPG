...
insert into public.spell_catalog (
  ...
  (
    'acid-arrow', 'Acid Arrow', 'Кислотная стрела', 2, 'Воплощение', 'Действие', '90 футов',
  ...
  (
    'acid-splash', 'Acid Splash', 'Кислотные брызги', 0, 'Воплощение', 'Действие', '60 футов',
  ...
  (
    'aid', 'Aid', 'Подмога', 2, 'Ограждение', 'Действие', '30 футов',
  ...
  (
    'alarm', 'Alarm', 'Сигнал тревоги', 1, 'Ограждение', '1 минута', '30 футов',
  ...
  (
    'bane', 'Bane', 'Порча', 1, 'Очарование', 'Действие', '30 футов',
  ...
  (
    'beacon-of-hope', 'Beacon of Hope', 'Маяк надежды', 3, 'Ограждение', 'Действие', '30 футов',
  ...
  (
    'bless', 'Bless', 'Благословение', 1, 'Очарование', 'Действие', '30 футов',
  ...
  (
    'burning-hands', 'Burning Hands', 'Пылающие ладони', 1, 'Воплощение', 'Действие', 'На себя',
