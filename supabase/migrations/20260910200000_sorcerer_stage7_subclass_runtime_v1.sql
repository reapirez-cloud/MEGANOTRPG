...
begin
  ...
  v_levels:=jsonb_build_array(
    ...
    jsonb_build_object('level',6,'mechanics',jsonb_build_array(
      private.sorcerer_stage7_feature_v1('lunar-boons','sorcerer:lunar:boons','sorcerer_lunar_boones','Лунные дары','Активная фаза даёт преимущество на связанные проверки характеристик. Ограниченное число применений восстанавливается после долгого отдыха.','{"kind":"lunar_boons"}'::jsonb),
