-- Validate a simple move before leaving its authorized Cheburashka RPC.
-- No private helper is exposed to authenticated callers.
...
begin
  ...
  -- The inventory constraint triggers are deferred. Fire them while this
  -- SECURITY DEFINER RPC still holds the private validator privileges.
  -- Restore their default deferred mode for any later commands in this transaction.
  set constraints
    public.character_inventory_items_validate_equipment_conflicts,
    public.character_inventory_items_validate_holder,
    public.character_inventory_items_validate_spatial_state,
    public.character_inventory_items_validate_specialized_capacity
  immediate;
  set constraints
    public.character_inventory_items_validate_equipment_conflicts,
    public.character_inventory_items_validate_holder,
