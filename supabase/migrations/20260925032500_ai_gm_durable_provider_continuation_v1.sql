-- Durable provider continuation for AI GM turns.
-- Queued continuations wake immediately; hard-killed workers become recoverable
-- after 3 minutes, safely beyond the current 150s hosted Edge wall-clock limit.
