-- AI GM automatic player roll bridge.
-- Exposes a pending roll request only to the authenticated owner of the PC,
-- allowing the client to auto-resolve it through resolve_player_roll_request_v1.
