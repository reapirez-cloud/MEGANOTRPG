-- Fix replay/undo rollback after character_survival_runtime schema dropped created_at.
-- Without this, AI-GM regenerate and undo fail before a new model can start.
...
comment on function private.rollback_ai_survival_receipt_v1(uuid) is
  'Restores reversible survival state for an AI-GM revision using the current character_survival_runtime schema.';
